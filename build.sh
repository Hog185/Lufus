...
echo "Creating venv..."
python3 -m venv /tmp/lufus-build
source /tmp/lufus-build/bin/activate

echo "Installing dependencies..."
pip install nuitka pyinstaller pyqt6 psutil pyudev packaging platformdirs
